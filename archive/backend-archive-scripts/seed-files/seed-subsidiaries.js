...
async function clearAndSeedSubsidiaries() {
  try {
    ...
    console.log('✅ Existing subsidiaries cleared');
    ...
    console.log('🎉 Successfully seeded all NUSANTARA GROUP subsidiaries!');
...
module.exports = { clearAndSeedSubsidiaries };

// Run if called directly
if (require.main === module) {
  clearAndSeedSubsidiaries()
    .then(() => process.exit(0))
    .catch(error => {
      console.error(error);
      process.exit(1);
