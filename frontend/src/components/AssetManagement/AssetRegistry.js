      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-[#0b0f19]/90 backdrop-blur-xl rounded-2xl p-5 border border-white/10">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs uppercase tracking-[0.2em] text-white/50 mb-2">Aktif</p>
          ...
          <div className="bg-[#0b0f19]/90 backdrop-blur-xl rounded-2xl p-5 border border-white/10">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs uppercase tracking-[0.2em] text-white/50 mb-2">Perawatan</p>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:ring-2 focus:ring-[#0ea5e9] focus:border-transparent transition-all"
              />
            </div>
            ...
            <select 
              ...
              className="px-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white focus:ring-2 focus:ring-[#0ea5e9] transition-all"
            >
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 bg-emerald-500 text-white rounded-xl hover:bg-emerald-500/90 transition-all shadow-lg shadow-emerald-500/20"
              >
          ...
          <div className="bg-[#0b0f19]/90 backdrop-blur-xl rounded-2xl border border-white/10 p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="px-3 py-1.5 text-sm bg-red-500 text-white rounded-lg hover:bg-red-500/90 disabled:opacity-50"
              >
                Tutup
              </button>
            </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-white/5 border-b border-white/10">
                <tr>
                  <th className="px-3 py-4 text-left text-xs font-medium text-white/50 uppercase tracking-[0.15em] w-8">
                    
                  </th>
                  <th className="px-3 py-4 text-left text-xs font-medium text-white/50 uppercase tracking-[0.15em]">
                    Aset
                  </th>
                  <th className="px-3 py-4 text-left text-xs font-medium text-white/50 uppercase tracking-[0.15em]">
                    Kategori & Lokasi
                  ...
                  <tr className="bg-white/5">
                    ...
                    <td className="px-3 py-3">
                      <input
                        ...
                        required
                        className="w-full px-3 py-2 mb-2 bg-white/10 border border-white/10 rounded-xl text-xs text-white placeholder-white/40 focus:ring-2 focus:ring-[#0ea5e9] focus:border-transparent transition-all"
                      />
                      <input
                        type="text"
                        name="assetName"
                        ...
                        required
                        className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-xl text-xs text-white placeholder-white/40 focus:ring-2 focus:ring-[#0ea5e9] focus:border-transparent transition-all"
                      />
                    </td>
                    <td className="px-3 py-3">
                      <select
                        ...
                        onChange={handleInputChange}
                        required
                        className="w-full px-3 py-2 mb-2 bg-white/10 border border-white/10 rounded-xl text-xs text-white focus:ring-2 focus:ring-[#0ea5e9] transition-all"
                      >
                    ...
                    <td className="px-3 py-3">
                      <input
                        ...
                        onChange={handleInputChange}
                        placeholder="Harga"
                        className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-xl text-xs text-white placeholder-white/40 focus:ring-2 focus:ring-[#0ea5e9] focus:border-transparent transition-all mb-2"
                      />
                      <input
                        type="date"
                        name="purchaseDate"
                        ...
                        onChange={handleInputChange}
                        className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-xl text-xs text-white focus:ring-2 focus:ring-[#0ea5e9] focus:border-transparent transition-all"
                      />
                    </td>
                    <td className="px-3 py-3">
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full px-3 py-2 bg-white/10 border border-white/10 rounded-xl text-xs text-white focus:ring-2 focus:ring-[#0ea5e9] transition-all"
                      >
                        {Object.entries(statusTypes).map(([key, value]) => (
                          <option key={key} value={key}>{value}</option>
                        ))}
                    ...
                    <td className="px-3 py-3">
                      <div className="flex items-center justify-center gap-1">
                        <button
                          ...
                          className="p-1 bg-emerald-500 text-white rounded-xl hover:bg-emerald-500/90 transition-all disabled:opacity-50 shadow-lg shadow-emerald-500/20"
                          title="Simpan"
                        >
                          {submitLoading ? (
                        ...
                        <button
                          ...
                          className="p-1 bg-red-500 text-white rounded-xl hover:bg-red-500/90 transition-all"
                          title="Batal"
                        >
                          <X className="h-3 w-3" />
                        </button>
                ...
                {filteredAssets.length === 0 && !isAddingInline ? (
                  <tr>
                    <td colSpan="7" className="px-6 py-12 text-center bg-white/5 rounded-xl">
                      ...
                      <p className="text-sm text-white/40 mt-1">Silakan tambahkan aset baru</p>
                    </td>
                  </tr>
                ) : (
                    ...
                    <React.Fragment key={asset.id}>
                      <tr className="hover:bg-white/10 transition-colors">
                        ...
                        <td className="px-3 py-3">
                          ...
                          <div className="text-xs text-white/60 mt-0.5">{asset.location || '-'}</div>
                        </td>
                        <td className="px-3 py-3">
                        ...
                        <td className="px-3 py-3 text-center">
                          <span className={`inline-block px-2 py-0.5 text-xs font-semibold rounded-full border ${getConditionColor(asset.condition)} bg-white/10`}>
                        ...
                        <td className="px-3 py-3">
                          <div className="flex items-center justify-center gap-1">
                            <button
                              ...
                              className="p-1 text-[#0ea5e9] hover:bg-[#0ea5e9]/10 rounded-xl transition-colors"
                              title="Edit"
                            >
                            ...
                            <button
                              ...
                              className="p-1 text-red-500 hover:bg-red-500/10 rounded-xl transition-colors"
                              title="Hapus"
                            >
