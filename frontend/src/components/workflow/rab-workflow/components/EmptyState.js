 ...
 * Displays when no RAP items exist with enhanced CTA
 */
  ...
  return (
    <div className="text-center py-16">
      <div className="mb-6">
        ...
        <h3 className="text-xl font-semibold text-white mb-2">Belum Ada Item RAP</h3>
        <p className="text-[#8E8E93] mb-6 max-w-md mx-auto">
          Mulai kelola RAP project Anda dengan input massal yang efisien atau import dari Excel
        </p>
      </div>
