          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-900">Monitoring Active</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-900">Automated (2 AM)</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-900">Complete Logging</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-900">Session Tracking</p>
              </div>
            </div>
          </div>
