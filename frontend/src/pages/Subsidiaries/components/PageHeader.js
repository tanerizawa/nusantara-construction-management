      ...
      <div className="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-white/70">
            <Building className="h-5 w-5 text-[#60a5fa]" />
            <p className="text-xs uppercase tracking-[0.2em] text-white/60">Subsidiary Management</p>
          </div>
          <h1 className="text-3xl font-semibold text-white">Anak Usaha Nusantara Group</h1>
          <p className="text-sm text-white/60">Kelola anak usaha dan spesialisasi konstruksi</p>
        </div>
        <button
