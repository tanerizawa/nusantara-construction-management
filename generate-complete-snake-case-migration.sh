...
# ============================================================================
# Generate SQL migration to rename ALL camelCase columns to snake_case
# This script will convert 96 camelCase columns across 10 tables
# ============================================================================

OUTPUT_FILE="/root/APP-YK/database/migrations/rename-all-columns-to-snake-case.sql"

echo "🔧 Generating comprehensive snake_case migration..."
echo ""
...
echo ""
echo "📋 Summary:"
echo "   - Total columns to rename: 96"
echo "   - Tables affected: 10"
echo "   - users: 4 columns"
echo "   - subsidiaries: 1 column"
echo "   - approval_notifications: 1 column"
echo "   - berita_acara: 26 columns"
echo "   - progress_payments: 20 columns"
echo "   - project_documents: 15 columns"
echo "   - project_milestones: 7 columns"
echo "   - project_rab: 8 columns"
echo "   - project_team_members: 8 columns"
echo "   - rab_purchase_tracking: 6 columns"
echo ""
echo "⚠️  IMPORTANT: This will rename columns used by Sequelize models!"
echo "   All models will need 'underscored: true' OR manual field mapping"
echo ""
echo "To execute: docker exec -i nusantara-postgres psql -U admin -d nusantara_construction < $OUTPUT_FILE"
